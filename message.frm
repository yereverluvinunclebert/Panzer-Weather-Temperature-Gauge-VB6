...
Private Sub Form_Activate()
   ...
   On Error GoTo Form_Activate_Error
    ...
    gblMessageAHeightTwips = fGetINISetting("Software\PzStorageGauge", "messageAHeightTwips", gblSettingsFile)
    gblMessageAWidthTwips = fGetINISetting("Software\PzStorageGauge", "messageAWidthTwips ", gblSettingsFile)
...
Private Sub Form_Resize()
    ...
    sPutINISetting "Software\PzStorageGauge", "messageAHeightTwips", gblMessageAHeightTwips, gblSettingsFile
    sPutINISetting "Software\PzStorageGauge", "messageAWidthTwips", gblMessageAWidthTwips, gblSettingsFile
...
Public Property Let propTitle(ByVal newValue As String)
   On Error GoTo propTitle_Error
    ...
    If mPropTitle = "" Then
        Me.Caption = "Panzer-Storage-Gauge-" & gblCodingEnvironment & " Message."
    Else
