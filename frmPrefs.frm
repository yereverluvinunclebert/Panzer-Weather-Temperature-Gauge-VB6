   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":14F2
            Left            =   1530
            List            =   "frmPrefs.frx":14F4
            Style           =   2  'Dropdown List
            TabIndex        =   52
   ...
   Begin VB.Frame fraConfig 
      ...
      Begin VB.Frame fraConfigInner 
         ...
         Begin VB.ComboBox cmbTickSwitchPref 
            Height          =   315
            ItemData        =   "frmPrefs.frx":72C8
            Left            =   2025
            List            =   "frmPrefs.frx":72CA
            Style           =   2  'Dropdown List
            TabIndex        =   171
            Top             =   6435
            Width           =   1620
...
Private Sub sliGaugeSize_Change()
    ...
    If gblAllowSizeChangeFlg = True Then Call fTemperature.AdjustZoom(sliGaugeSize.Value / 100)
